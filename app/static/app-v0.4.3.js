...
function openJobModal(clientId,action,title){
 ...
 $('#job-modal-title').textContent=title;$('#job-modal-client').textContent=clientId.toUpperCase();const build=$('#job-ui-build');if(build)build.textContent='UI 0.4.3';
 ...
 $('#job-modal-close').disabled=false;$('#job-modal-close').dataset.redirect='';$('#job-modal-footer-close').hidden=true;dlg.showModal();
}
